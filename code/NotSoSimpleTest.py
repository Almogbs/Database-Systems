...
class Test(AbstractTest):
    ...
    def test_getDisksContainingTheMostData(self):
        ...
        self.assertEqual(ReturnValue.OK, Solution.addDiskAndPhoto(Disk(4,"HP",10,10,10), Photo(7,"stuff",10)), "Should work")
        self.assertEqual(ReturnValue.OK,Solution.addPhotoToDisk(Photo(7,"stuff",10),4),"Should work")
        self.assertListEqual([4, 1, 2, 3], Solution.getDisksContainingTheMostData(), "size of 2 is 0, size of 1 is 0, 3 is 0")
        self.assertEqual(ReturnValue.OK,Solution.addPhotoToDisk(Photo(7,"stuff",10),3),"Should work")
        self.assertListEqual([3, 4, 1, 2], Solution.getDisksContainingTheMostData(), "size of 2 is 0, size of 1 is 0, 3 is 0")
